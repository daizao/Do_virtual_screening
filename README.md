...
### Please pay attention to the following issues before calculation
	...
	2.Prepare yourself's protein pdbqt and Grid box file (if you want make a Grid box,
		the pdbqt must be provided. So we do not make a batch script to produce pdbqt files).  
